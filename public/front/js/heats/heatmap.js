                  ...
                  .on("mouseover", function(d) {
                         if (d.parent.name != "MARKET") {
                             d3.select("#tooltip").transition()
                                .duration(200)
                                .style("opacity", 1);
                             d3.select("#tooltip").html("<div class='info-bl'><h3>"+d.name+"11</h3><table><thead><tr><td>Value</td><td>Month change</td></tr></thead>"+
                                      "<tr><td>"+d.value+"</td><td> ("+d['_children'][0]['rate']+"%)</td></tr>"+
                                      "</table></div>")
