...
@section('content')
        ...
        <script>
            $(function() {
                ...
                $(document).ready(function(){
                    ...
                    toastr.success('{{session('message')}}', 'Облигации', {timeOut: 5000})
                })
            });
        </script>
    @endif
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Облигация</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.home')}}">Главная</a></li>
                        <li class="breadcrumb-item active">Облигации</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header d-flex p-2" style="background-color: rgba(0,0,0,.03);">
                            ...
                            <ul class="nav nav-pills ml-auto">
                                <li class="nav-item">
                                    <a href="{{ route('bonds.create') }}" class="btn btn-success">
                                        Добавить
                                    </a>
                                </li>
                            </ul>
                                ...
                                <table class="table m-0" style="min-height: 200px;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->title }}</td>
                                            <td style="width: 1%;">
                                                <a class="" href="{{ route('bonds.edit', ['id' => $item->id]) }}">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-danger">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="{{ route('bonds.delete', ['id' => $item->id]) }}" class="btn btn-outline-light">Удалить</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
