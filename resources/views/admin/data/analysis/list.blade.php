        ...
        <script>
            $(function() {
                ...
                $(document).ready(function(){
                    ...
                    toastr.success('{{session('message')}}', 'Analysis', {timeOut: 5000})
                })
            });
        </script>
    @endif
                    ...
                    <div class="card">
                        <div class="card-header d-flex p-2" style="background-color: rgba(0,0,0,.03);">
                            ...
                            <ul class="nav nav-pills ml-auto">
                                <li class="nav-item">
                                    <a href="{{ route('data.create.analysis') }}" class="btn btn-success">
                                        Добавить
                                    </a>
                                </li>
                            </ul>
                                                ...
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        ...
                                                        <div class="dropdown-menu" style="padding: 0">
                                                            <a class="dropdown-item link-edit" href="{{ route('data.edit.analysis', ['id'=> $item->id]) }}">
                                                                <span class="edit action"><i class="far fa-edit"></i></span>
                                                                Изменить
                                                            </a>
                                                            <div class="dropdown-divider" style="margin: 0;"></div>
                                                            <a class="dropdown-item link-lang" href="{{ route('data.trans.analysis', ['id' => $item->info->id, 'lang' => 'en']) }}">
                                                                <span class="lang action"><i class="fas fa-globe-asia"></i></span>Перевод eng
                                                            </a>
                                                            <a class="dropdown-item link-lang" href="{{ route('data.trans.analysis', ['id' => $item->info->id, 'lang' => 'uz']) }}">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-danger">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="{{ route('data.delete.analysis', ['id' => $item->info->id]) }}" class="btn btn-outline-light">Удалить</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
