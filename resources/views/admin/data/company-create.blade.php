            ...
            <form action="{{ route('data.create.comp') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Название" id="title" name="title" required>
                </div>
                <div class="my-2">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Название" id="isin" name="isin" required>
                </div>
                <div class="form-group">
                  <label for="issuer" class="required">Issuer</label>
                  <input type="text" class="form-control" placeholder="Название" id="issuer" name="issuer" required>
                </div>
