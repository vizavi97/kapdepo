                        ...
                        <form action="{{ route('data.edit.comp', $company->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Название" value="{{ $company->title }}" id="title" name="title">
                                </div>
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" @if($company->kdindex == true) checked @endif  name="kdindex" id="kdindex">
                                        <label class="form-check-label" for="kdindex">Kdindex</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="isin" class="required">Isin</label>
                                    <input type="text" class="form-control" placeholder="Название" value="{{ $company->isin }}" id="isin" name="isin">
                                </div>
                                <div class="form-group">
                                    <label for="issuer" class="required">Issuer</label>
                                    <input type="text" class="form-control" placeholder="Название" value="{{ $company->issuer }}" id="issuer" name="issuer">
                                </div>
                                ...
                                <div class="callout callout-info">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="textarea" name="body" id="body" >{{ $company->info->desc }}</textarea>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Название" id="address" value="{{ $company->info->address }}" name="address">
                                    </div>
                                    <div class="form-group">
                                        <label for="phone" class="">Телефон</label>
                                        <input type="text" class="form-control" placeholder="Название" id="phone" value="{{ $company->info->phone }}" name="phone">
                                    </div>
                                    <div class="form-group">
                                        <label for="site" class="">Сайт</label>
                                        <input type="text" class="form-control" placeholder="Название" id="site" value="{{ $company->info->site }}" name="site">
                                    </div>
                                    <div class="form-group">
                                        <label for="sector" class="">Сектор (Sector)</label>
                                        <input type="text" class="form-control" placeholder="Название" id="sector" value="{{ $company->info->sector }}" name="sector">
                                    </div>
                                    <div class="form-group">
                                        <label for="industry" class="">Промышленность (Industy) </label>
                                        <input type="text" class="form-control" placeholder="Название" id="industry" value="{{ $company->info->industry }}" name="industry">
                                    </div>
                                </div>
