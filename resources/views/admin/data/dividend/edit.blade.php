            ...
            <form action="{{ route('dividend.edit', $data->id) }}" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select required id="comp_id" name="company_id" class="form-control">
                    ...
                    @foreach($comps as $item)
                      <option @if($item->id == $data->company_id) selected="selected"
                ...
                <div class="form-group">
                  ...
                  <input required type="text" class="form-control" placeholder="Год" value="{{ $data->year }}" id="year"
                         name="year">
                </div>

                <div class="form-group">
                  <label for="sum" class="required">Сумма</label>
                  <input required type="text" class="form-control" placeholder="Сумма" value="{{ $data->sum }}" id="sum"
                         name="sum">
                </div>
                <div class="form-group">
                  <label for="procent" class="required">%</label>
                  <input required type="text" class="form-control" placeholder="%" value="{{ $data->procent }}"
                         id="procent" name="procent">
                </div>
                <div class="form-group">
                  <label for="preference" class="required">По превелигированным акциям</label>
                  <input type="text" class="form-control" placeholder="%" value="{{ $data->preference }}" id="preference" name="preference">
                </div>
                <div class="form-group">
                  <label for="preferencePercent" class="required">% По превелигированным акциям</label>
                  <input type="text" class="form-control" placeholder="%" value={{ $data->preferencePercent }} id="preferencePercent"
