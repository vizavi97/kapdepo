...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Добавить историю</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{ route('history.create') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="number" class="form-control" placeholder="Описание" id="desc" name="desc"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="year" class="required">Год</label>
                                    <input type="number" class="form-control" placeholder="Год" id="year" name="year">
                                </div>
                                <div class="form-group">
