...
@section('content')
        ...
        <script>
            $(function() {
                ...
                $(document).ready(function(){
                    ...
                    toastr.success('{{session('message')}}', 'Analytics', {timeOut: 5000})
                })
            });
        </script>
    @endif
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"> Kd - Analytics</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header d-flex p-2" style="background-color: rgba(0,0,0,.03);">
                            ...
                            <ul class="nav nav-pills ml-auto">
                                <li class="nav-item">
                                    <a href="{{ route('analytics.create') }}" class="btn btn-success">
                                        Добавить
                                    </a>
                                </li>
                            </ul>
                                                ...
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        ...
                                                        <div class="dropdown-menu" style="padding: 0">
                                                            <a class="dropdown-item link-edit" href="{{ route('analytics.edit', ['id'=> $item->id]) }}">
                                                                <span class="edit action"><i class="far fa-edit"></i></span>
                                                                Изменить
                                                            </a>
                                                            <div class="dropdown-divider" style="margin: 0;"></div>
                                                            <a class="dropdown-item link-lang" href="{{ route('analytics.trans', ['id' => $item->id, 'lang' => 'en']) }}">
                                                                <span class="lang action"><i class="fas fa-globe-asia"></i></span>Перевод eng
                                                            </a>
                                                            <a class="dropdown-item link-lang" href="{{ route('analytics.trans', ['id' => $item->id, 'lang' => 'uz']) }}">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-danger">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="{{ route('analytics.delete', ['id' => $item->id]) }}" class="btn btn-outline-light">Удалить</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
