...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Перевод {{ $new->title }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.home')}}">Главная</a></li>
                        <li class="breadcrumb-item"><a href="{{route('new.list')}}">Новости</a></li>
                        <li class="breadcrumb-item active">Перевод {{ $new->lang }}</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="lang" name="lang" disabled>
                                        {{--<option value="ru" @if($new->lang == 'ru') selected="selected" @endif> Русский </option>--}}
                                        <option value="uz" @if($new->lang == 'uz') selected="selected" @endif> Узбекский </option>
                                        <option value="en" @if($new->lang == 'en') selected="selected" @endif> Английский </option>
                                    </select>
