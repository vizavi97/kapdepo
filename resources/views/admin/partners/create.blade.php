...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Добавить партнёра</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.home')}}">Главная</a></li>
                        <li class="breadcrumb-item"><a href="{{route('partners.list')}}">Партнёры</a></li>
                        <li class="breadcrumb-item active">Добавить партнёра</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form action="{{ route('partners.create') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" placeholder="Описание" id="desc" name="desc"></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Вставьте ссылку" id="link" name="link">
                                </div>
