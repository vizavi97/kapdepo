...
@section('content')
        ...
        <script>
            $(function() {
                ...
                $(document).ready(function(){
                    ...
                    toastr.success('{{session('message')}}', 'Сотрудник', {timeOut: 5000})
                })
            });
        </script>
    @endif
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Наша команда</h1>
                </div>
                <div class="col-sm-6">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend">
                                                            ...
                                                            <div class="dropdown-menu" style="padding: 0">
                                                                <a class="dropdown-item link-edit" href="{{ route('team.edit', ['id'=> $item->id]) }}">
                                                                    <span class="edit action"><i class="far fa-edit"></i></span>
                                                                    Изменить
                                                                </a>
                                                                <div class="dropdown-divider" style="margin: 0;"></div>
                                                                <a class="dropdown-item link-lang" href="{{ route('team.trans', ['id' => $item->id, 'lang' => 'en']) }}">
                                                                    <span class="lang action"><i class="fas fa-globe-asia"></i></span>Перевод eng
                                                                </a>
                                                                <a class="dropdown-item link-lang" href="{{ route('team.trans', ['id' => $item->id, 'lang' => 'uz']) }}">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content bg-danger">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="{{ route('team.delete', ['id' => $item->id]) }}" class="btn btn-outline-light">Удалить</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
