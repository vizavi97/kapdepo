            ...
            <form action="{{ route('team.edit', ['id' => $person->id]) }}" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Введите фамилию" value="{{ $person->surname }}"
                         id="surname" name="surname">
                </div>
                <div class="form-group">
                  <label for="name" class="required">Имя</label>
                  <input type="text" class="form-control" placeholder="Введите имя" value="{{ $person->name }}"
                         id="name" name="name">
                </div>
                <div class="form-group">
                  <label for="patronymic">Отчество</label>
                  <input type="text" class="form-control" placeholder="Введите отчество"
                         value="{{ $person->patronymic }}" id="patronymic" name="patronymic">
                </div>
                <div class="form-group">
                  <label for="position" class="required">Должность</label>
                  <input type="text" class="form-control" placeholder="Введите должность"
                         value="{{ $person->position }}" id="position" name="position">
                </div>
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        ...
                        <img src="/storage/{{ $person->photo }}" alt=""
                ...
                <div class="callout callout-info">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" placeholder="Введите e-mail" value="{{ $person->email }}"
                           id="email" name="email">
                  </div>
                  <div class="form-group">
                    <label for="phone_one" class="required">Тел. 1</label>
                    <input type="text" class="form-control" placeholder="Введите номер" value="{{ $person->phone_one }}"
                           id="phone_one" name="phone_one">
                  </div>
                  <div class="form-group">
                    <label for="phone_two">Тел. 2</label>
                    <input type="text" class="form-control" placeholder="Введите номер" value="{{ $person->phone_two }}"
                           id="phone_two" name="phone_two">
                  </div>
                ...
                <div class="form-group">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" @if($person->public == true) checked
                           @endif  name="publish" id="publish">
