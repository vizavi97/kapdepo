                    ...
                    @foreach($comps as $item)
                        <tr>
                            ...
                            <td>{{  isset($item['data']->data->last_price) ? $item['data']->data->last_price : '-'  }}</td>
                                ...
                                <td><span style="@if($item['change_1'] > 0) color: #39b839; @else color:red; @endif">{{ $item['change_1'] }}</span> </td>
                                <td><span style="@if($item['change_1'] > 0) color: #39b839;@else  color:red;@endif">%{{ $item['change_2'] }}</span></td>
