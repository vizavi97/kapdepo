...
@section('main_head')
  <section class="banner-section">
    <div class="banner-page-new">
      <div class="item">
        <div class="bg_header"
             style="background: url({{ asset('front/bonds.jpg') }}) no-repeat; background-size: cover; background-position: center;"></div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-7">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p style="font-weight: bold;">{{ $item->title }}
                    <span>{{ date('d-m-Y', strtotime($item->created_at)) }}</span></p>
                  <p>{!! $item->body !!}</p>
                </div>
                <div class="modal-footer">
                  <p class="block-file">
                    <a target="_blank" href="/storage/{{ $item->file }}"><span><i class="fas fa-file-pdf"></i></span>
                      Файл</a>
                  </p>
                </div>
              </div>
        ...
        @endforeach
        @include('tim.static.comments.template',['comments' => $comments,'section' => $parent])
