...
@section('main_head')
  <section class="banner-section">
    <div class="banner-page-new">
      <div class="item">
        <div class="bg_header"
             style="background: url({{ asset('front/news-page.jpg') }}) no-repeat; background-size: cover; background-position: top;"></div>
...
@section('content')
  <section class="block-news-item">
    <div class="container">
      ...
      @include('tim.static.comments.template',['comments' => $comments,'parent' => $parent, "categories_id" => $item->id])
