...
@section('main_head')
    <section class="banner-section">
        <div class="banner-page-new">
            <div class="item">
                <div class="bg_header" style="background: url({{ asset('front/start-trade.jpg') }}) no-repeat; background-size: cover; background-position: bottom;"></div>
    ...
    <section>
        <div class="container">
            <div class="row">
                @switch(App::getLocale())
                    @case('ru')
                        @include('templates.private.start-ru')
                    @break
                    @case('en')
                        @include('templates.private.en.start-en')
                    @break
                    @case('uz')
                        @include('templates.private.uz.start-uz')
                    @break
                @endswitch
            </div>
        </div>
